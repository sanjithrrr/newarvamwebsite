...
import banner from '../../../../public/asset/images/solution-banner.png'
...
export default function Banner() {
    return (
        <div>
            <div className='grid grid-cols-2 max-lg:grid-cols-1 gap-15 gap-y-10 p-10 pe-5 '>
                <div>
                    ...
                    <h1 className='text-[22px] mt-6 text-justify '>A shop floor friendly EAM solution with latest and greatest technology components to meet modern day demands yet simple in construction and use</h1>
                ...
                <Image className='flex mx-auto max-lg:order-first -mt-10' alt='banner' src={banner} /></div>

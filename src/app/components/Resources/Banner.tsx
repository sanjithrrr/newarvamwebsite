        ...
        <div>
            <div className='grid grid-cols-2 max-lg:grid-cols-1 gap-15 gap-y-10 p-10 pe-5 '>
                <div>
                    ...
                    <h1 className='text-[22px] mt-6 text-justify '>Our Enterprise Asset Management (EAM) is a best of breed application suitable
                ...
                <Image className='-mt-25 flex mx-auto max-lg:order-first ' alt='banner' src={banner} />
            </div>
        </div>
    )
}

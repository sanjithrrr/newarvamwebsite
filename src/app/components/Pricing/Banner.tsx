        ...
        <div>
            <div className='grid grid-cols-2 max-lg:grid-cols-1 gap-15 gap-y-10 p-10 pe-5 '>
                <div>
                    ...
                    <h1 className='text-[22px] mt-6 text-justify '>Collaborate with our implementation team to choose the best plan for your company and begin engineering uptime outcomes immediately.</h1>

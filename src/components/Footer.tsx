...
export function Footer() {
  ...
  return (
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 lg:grid-cols-3">
        ...
        <div className="py-8 mt-8 border-t border-gray-100 text-center">
          <p className="text-gray-500">
            © 2025 Arvam Solutions. All rights reserved.
          </p>
        </div>
      </Container>
    </div>
